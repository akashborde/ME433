...
#define ASCII_TBL_LENGTH 5
#define HEIGHT_CHAR 8
// lookup table for all of the ascii characters
static const char ASCII[96][ASCII_TBL_LENGTH] = {
...
#define CENTER_X (ILI9341_TFTWIDTH / 2)
#define CENTER_Y (ILI9341_TFTHEIGHT/ 2)

//progress bar length
#define PROG_BAR_HEIGHT 5
#define PROG_BAR_LEN 100

//define limits for acceleration
#define ACCEL_1G 16000


// functions
void LCD_init();
void SPI1_init(); //pretty standard setup
unsigned char spi_io(unsigned char o); //Send a byte of SPI
void LCD_command(unsigned char com) ; // sends a command with spi and DC
void LCD_data(unsigned char dat); //sends data in a byte
void LCD_data16(unsigned short dat); //sends 2 bytes of data from a short
void LCD_setAddr(unsigned short x, unsigned short y, unsigned short w, unsigned short h);
void LCD_drawPixel(unsigned short x, unsigned short y, unsigned short color);
void LCD_clearScreen(unsigned short color);
//draw a letter with font color fc and background color bkc
void LCD_drawLetter(char letter, unsigned short x, unsigned short y, unsigned short fc, unsigned short bkc);
//print a string at a point (x,y)
